        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">faites vos réservations</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="accueil">Home</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="contact">contact</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="a-propos">a-propos</li>
                        </ol>
                    </nav>
                </div>
            </div>
