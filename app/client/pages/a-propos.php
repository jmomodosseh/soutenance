    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                <h4 class="section-title bg-white text-center text-primary px-3">Nous sommes</h4>
                <h1 class="mb-5"></h1>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h4>Nous sommes une structure de cinéma qui vous offre des moments de détente et de divertissement... on diffuse des films à la une des nouveautés dans le cinéma dans nos différentes salles de spectacle...<br> nous sommes Spect+ <h4>
                    <h4 class="mb-4"></h4>
                    <p class="mb-4"> </p>
                    <p class="mb-4">     </p>
