...
<head>
  ...
  <title>inscription_Directeur</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="/Soutenance/public/images/favicon.png" rel="icon">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Créons votre compte</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="post" action="backend/register.php">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous avez déja un compte? <a href="/Soutenance/app/Directeur/connexion/index.php">Se connecter</a></p>
                    </div>
                  </form>
